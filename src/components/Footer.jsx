        ...
        <div className="container-xxl">
          <div id="footer-top" className="row align-items-center">
            <div id="footer-top-element1" className="col-sm-12 col-md-12 col-lg-5 col-xl-5 col-xxl-5col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
              <div id='footer-top-element1-child' className="footer-top-data d-flex gap-30 align-items-center">
            ...
            <div id="footer-top-element2" className="col-7">
                ...
                <div id='footer-top-element2-child' class="input-group">
                  <input 
      ...
      <footer className='py-4'>
        <div className="container-xxl">
          <div id="footer-middle" className="row">
            <div id="footer-middle-element1" className="col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
              ...
              <div className="footer-link d-flex flex-column">
                ...
                <div id='social_icons' className="social_icons d-flex align-items-center gap-30 mt-4">
            ...
            <div id="footer-middle-element2" className="col-sm-12 col-md-5 col-lg-3 col-xl-3 col-xxl-3">
              <h4 className='text-white mb-4'>Information</h4>
              <div id='footer-links' className="footer-link d-flex flex-column">
            ...
            <div id="footer-middle-element3" className="col-sm-12 col-md-5 col-lg-3 col-xl-3 col-xxl-3">
            ...
            <div id="footer-middle-element4" className="col-sm-12 col-md-5 col-lg-2 col-xl-2 col-xxl-2">
